...
def print_reveal_letters(wrd, lst):
    for i in wrd:
        if i in lst:
            print(i, end='')
        else:
...
def play(word):
    ...
    while True:
        ...
        if guessed:
            break
        user_guess = input('Ввведите загаданные букву или слово: ').upper()
        if not user_guess.isalpha():
            print('Необходимо ввести букву или слово') 
            continue
        if user_guess in guessed_letters or user_guess in guessed_words:
            print('Уже было')
            continue
        ...
        if len(user_guess) == 1:
            ...
            if user_guess in guessed_letters:
                ...
                if user_guess in word:
                    ...
                    print_reveal_letters(word, guessed_letters)
                    print()
                    counter = 0
